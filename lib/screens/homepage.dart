...
class _HomePageState extends State<HomePage> {
  ...
  Widget _buildDressIcon() {
    ...
    List<Product> dress = categoryProvider.getFootballList.toList();
    return Row(
  ...
  Widget _buildShirtIcon() {
    List<Product> shirts = categoryProvider.getBasketballList.toList();
  ...
  Widget _buildShoeIcon() {
    ...
    List<Product> shoes = categoryProvider.getJordanList.toList();
    return Row(
  ...
  Widget _buildPantIcon() {
    ...
    List<Product> pant = categoryProvider.getRunningList.toList();
    return Row(
  ...
  Widget _buildTieIcon() {
    ...
    List<Product> tie = categoryProvider.getGymList.toList();
    return Row(
